    ...
    <div class="fp-videos__grid">
        ...
        <div class="video-card">
            <div class="video-card__embed">
                <iframe src="<?php echo esc_url( $embed_url ); ?>" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen loading="lazy" title="<?php echo esc_attr( $vid_title ); ?>"></iframe>
            </div>
